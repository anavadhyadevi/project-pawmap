    ...
    <div className="pm-lf-page">
      ...
      <section className="pm-lf-hero">
        <div className="container-pm">
          ...
          <h1 className="pm-lf-hero__title">
          ...
          {loading ? (
            ...
            <div className="pm-lf-grid">
              {items.map((item) => {
                ...
                const openId =
                  contactItem?.lost_report_id ||
                  contactItem?.found_report_id
                ...
                return (
                  <article
                    key={itemId}
                    className="pm-lf-card"
                  >
                    <div className="pm-lf-card__photo">
                      {item.photo ? (
                        <img
                          src={item.photo}
                          alt={item.pet_name || item.species}
                          loading="lazy"
                        />
                      ) : (
                        <div
                      ...
                      <span
                        className={`pm-lf-card__status pm-lf-card__status--${item.status.toLowerCase()}`}
                      >
                        {item.status}
                      </span>
                    </div>
                    ...
                    <div className="pm-lf-card__body">
                      <h3>
                        {item.pet_name || `Unnamed ${item.species}`}
                      </h3>
                      ...
                      {item.distinguishing_features && (
                        <p className="pm-lf-card__features">
                          {item.distinguishing_features}
                        </p>
                      )}
